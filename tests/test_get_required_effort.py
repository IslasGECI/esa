...
d: dict = {'Fecha': ["2019-11-09", "2019-11-08", "2019-11-10", "2019-11-11"], 'Cantidad_de_trampas_activas': [1, 2, 3, 4], 'Cantidad_de_avistamientos': [1, 0, 0, 0]}
dates: pd.DataFrame = pd.DataFrame(data=d)
output_tests = {'effort_without_sighted': 3, 'required_effort': 3, 'significance_level': 0.050000000000000044,'success_probability': 0.99}
