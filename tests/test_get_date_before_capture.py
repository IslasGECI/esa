...
d: dict = {'Fecha': ["2019-11-09", "2019-11-08", "2019-11-10"], 'Cantidad_de_trampas_activas': [1, 2, 3], 'Cantidad_de_avistamientos': [1, 0, 0]}
dates: pd.DataFrame = pd.DataFrame(data=d)
e: dict = {'Fecha': ["2019-11-09", "2019-11-08"], 'Cantidad_de_trampas_activas': [1, 2], 'Cantidad_de_avistamientos': [1, 0]}
...
a: dict = {'Fecha': ["2019-11-10"], 'Cantidad_de_trampas_activas': [3], 'Cantidad_de_avistamientos': [0]}
